      ...
      <div className="mb-8">
        ...
        <div className="space-y-8">
          ...
          <section className="bg-muted/50 p-6 rounded-lg">
            ...
            <p className="mb-4">
              Contactanos por WhatsApp o Instagram <strong>@busy_streetwear</strong> con:
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" className="gap-2">
                <a href="https://www.instagram.com/busy_streetwear" target="_blank" rel="noopener noreferrer">
